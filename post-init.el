...
;;; taken from the setup doc for minimal-emacs
;; Ignoring some stuff, but I will list the packages that have a section in the doc
;; dumb-jump
;; yasnippets
;; avy
;; everything elisp under https://github.com/jamescherti/minimal-emacs.d#enhancing-the-elisp-development-experience
;; like aggressive-indent etc
;; inhibit-mouse
;; setq tab-bar-show
;; quick-sdcv (dictionary)
;; spelling stuff ispell etc
;; server
...
;; END of file/history management
;;------------------------------------------
...
;; END of auto-save mode
;;----------------------------


;;---- Many completion frameworks. Definitely not overkill. It seems they all work together
...
;; Setting corfu-auto to t to enable automatic completion is discouraged for both performance and security reasons
...
;; Enable the mode
;; Different modes/languages can use different folding backends
...
;; END of folding stuff
;;-------------------------

;; formatting without latency
...
;; diff-h for source control gutter indicators
...
;; END of buffer-terminator
;; -------------------


;; File tree explorer thingy treemacs
...
;; persist/restore text scale
(use-package persist-text-scale
  :init
  (setq text-scale-mode-step 1.07)
  (persist-text-scale-mode 1))

;; END of persist-text-scale

;;; hopefully this is actually a good terminal
...
;; END of terminal vterm
;; --------------------------

;; from section 'Which other customizations??'
;; just picking a few bits out
